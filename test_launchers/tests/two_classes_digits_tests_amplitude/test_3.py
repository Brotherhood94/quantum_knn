...
def test_3_no_pca(X, y, knn_k, test_iters, dataset, n_classes, n_features_real, training_type, test_size, comb):
    #TEST 3
    ...
    print_to_file(dataset+"_TEST_3_No_PCA_"+str(comb), KNN_exps, aQKNN_exps, None, None)
    aQKNN_exps = []
    KNN_exps = []

### TEST_3_PCA

def test_3_pca(X, y, knn_k, test_iters, dataset, n_classes, n_features_real, training_type, test_size, comb):
    ...
    for n_features_pca in (2**e for e in features_range): #start from 2, exponential step
        ...
        print_to_file(dataset+"_TEST_3_PCA:"+str(n_features_pca)+"_"+str(comb), KNN_exps, aQKNN_exps, None, None)
        aQKNN_exps = []
        KNN_exps = []
        di_test = []
